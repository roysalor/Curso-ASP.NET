...
public partial class AdventureWorksLTDataContext : System.Data.Linq.DataContext
{
  ...
  partial void DeleteSalesOrderDetail(SalesOrderDetail instance);
	...
	public System.Data.Linq.Table<CustomerAddress> CustomerAddress
	{
		get
		{
	...
	public System.Data.Linq.Table<ProductModelProductDescription> ProductModelProductDescription
	{
		get
		{
		...
		set
		{
						...
						|| (this._Address1.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.SalesOrderHeader1.Remove(this);
				}
...
public partial class Address : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<SalesOrderHeader> _SalesOrderHeader1;
	...
	public Address()
	{
		...
		this._SalesOrderHeader1 = new EntitySet<SalesOrderHeader>(new Action<SalesOrderHeader>(this.attach_SalesOrderHeader1), new Action<SalesOrderHeader>(this.detach_SalesOrderHeader1));
		this._CustomerAddress = new EntitySet<CustomerAddress>(new Action<CustomerAddress>(this.attach_CustomerAddress), new Action<CustomerAddress>(this.detach_CustomerAddress));
		OnCreated();
	}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Address_SalesOrderHeader", Storage="_SalesOrderHeader", ThisKey="AddressID", OtherKey="BillToAddressID")]
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Address_SalesOrderHeader1", Storage="_SalesOrderHeader1", ThisKey="AddressID", OtherKey="ShipToAddressID")]
	public EntitySet<SalesOrderHeader> SalesOrderHeader1
	{
		get
		{
		...
		set
		{
			this._SalesOrderHeader1.Assign(value);
		}
	}
	
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Address_CustomerAddress", Storage="_CustomerAddress", ThisKey="AddressID", OtherKey="AddressID")]
	...
	private void attach_SalesOrderHeader1(SalesOrderHeader entity)
	{
		this.SendPropertyChanging();
		entity.Address1 = this;
	}
	
	private void detach_SalesOrderHeader1(SalesOrderHeader entity)
	{
		this.SendPropertyChanging();
...
public partial class Customer : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Customer_CustomerAddress", Storage="_CustomerAddress", ThisKey="CustomerID", OtherKey="CustomerID")]
	public EntitySet<CustomerAddress> CustomerAddress
	{
		get
		{
	...
	public Address Address
	{
		...
		set
		{
						...
						|| (this._Address.HasLoadedOrAssignedValue == false)))
			{
				...
				{
					this._Address.Entity = null;
					previousValue.CustomerAddress.Remove(this);
				}
				this._Address.Entity = value;
				if ((value != null))
				{
...
public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_SalesOrderDetail", Storage="_SalesOrderDetail", ThisKey="ProductID", OtherKey="ProductID")]
	public EntitySet<SalesOrderDetail> SalesOrderDetail
	{
		get
		{
...
public partial class ProductCategory : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<ProductCategory> _ProductCategory2;
	...
	public ProductCategory()
	{
		...
		this._ProductCategory2 = new EntitySet<ProductCategory>(new Action<ProductCategory>(this.attach_ProductCategory2), new Action<ProductCategory>(this.detach_ProductCategory2));
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ProductCategory_ProductCategory", Storage="_ProductCategory2", ThisKey="ProductCategoryID", OtherKey="ParentProductCategoryID")]
	public EntitySet<ProductCategory> ProductCategory2
	{
		get
		{
		...
		set
		{
			this._ProductCategory2.Assign(value);
		}
	}
		...
		set
		{
						...
						|| (this._ProductCategory1.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.ProductCategory2.Remove(this);
				}
				this._ProductCategory1.Entity = value;
				if ((value != null))
				{
					value.ProductCategory2.Add(this);
	...
	private void attach_ProductCategory2(ProductCategory entity)
	{
		this.SendPropertyChanging();
		entity.ProductCategory1 = this;
	}
	
	private void detach_ProductCategory2(ProductCategory entity)
	{
		this.SendPropertyChanging();
...
public partial class ProductDescription : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private EntitySet<ProductModelProductDescription> _ProductModelProductDescription;
	...
	{
		this._ProductModelProductDescription = new EntitySet<ProductModelProductDescription>(new Action<ProductModelProductDescription>(this.attach_ProductModelProductDescription), new Action<ProductModelProductDescription>(this.detach_ProductModelProductDescription));
		OnCreated();
	}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ProductDescription_ProductModelProductDescription", Storage="_ProductModelProductDescription", ThisKey="ProductDescriptionID", OtherKey="ProductDescriptionID")]
	public EntitySet<ProductModelProductDescription> ProductModelProductDescription
	{
		get
		{
		...
		set
		{
			this._ProductModelProductDescription.Assign(value);
		}
	}
	...
	private void detach_ProductModelProductDescription(ProductModelProductDescription entity)
	{
		this.SendPropertyChanging();
...
public partial class ProductModel : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ProductModel_ProductModelProductDescription", Storage="_ProductModelProductDescription", ThisKey="ProductModelID", OtherKey="ProductModelID")]
	public EntitySet<ProductModelProductDescription> ProductModelProductDescription
	{
		get
		{
		...
		set
		{
						...
						|| (this._ProductDescription.HasLoadedOrAssignedValue == false)))
			{
				...
				if ((previousValue != null))
				{
					...
					previousValue.ProductModelProductDescription.Remove(this);
				}
